import 'package:bloc_pattern_apllication/bloc.dart';
import 'package:bloc_pattern_apllication/model.dart';
import 'package:bloc_pattern_apllication/provider.dart';
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) => ListTile(
                        leading: CircleAvatar(
                          child: Image.network("https://image.tmdb.org/t/p/w92" + snapshot.data[index].posterPath ?? ""),
                        ),
